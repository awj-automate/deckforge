      ...
      elements: [
        {
          ...
          fontWeight: '700', fontStyle: 'normal', color: '#1A1D23',
    ...
    create: (theme) => ({
      ...
      elements: [
        ...
        },
        {
          ...
          border: { width: 1, color: '#E2E5EB', dash: 'solid' }, cornerRadius: 12,
    ...
    create: (theme) => ({
      ...
      elements: [
        ...
        },
        {
          ...
          locked: false, hidden: false, blendMode: 'normal', zIndex: 1,
          fill: { type: 'solid', color: '#1A1D23' }, border: null,
    ...
    create: (theme) => ({
      ...
      elements: [
        ...
        },
        {
          ...
          fontWeight: '400', fontStyle: 'italic', color: '#1A1D23',
        ...
        },
        {
          ...
          fontWeight: '500', fontStyle: 'normal', color: '#1A1D23',
          lineHeight: 1.5, letterSpacing: 0, textAlign: 'left', verticalAlign: 'top',
          textShadow: null, background: null, border: null,
    ...
    create: (theme) => ({
      ...
      elements: [
        ...
        },
        {
          ...
          fontWeight: '600', fontStyle: 'normal', color: '#1A1D23',
